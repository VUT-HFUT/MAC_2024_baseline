...
def evaluate_mAP(preds, dataset, num_classes, sub_set):
...
if __name__ == '__main__':
    ...
    parser.add_argument('-pkl_path', type=str, default="/liupengyu/MS-TCT/save_logit_32_i3d8_B3_H4_new/56_test.pkl", required=False)  # './test.pkl'
    args = parser.parse_args()

    pkl_path = args.pkl_path

    gt_file = '/liupengyu/MLMAE_NOFACE/Label/test_crop.json'
    # gt_file = '/liupengyu/MLMAE_NOFACE/Label/MLMAE_MLAD_3_new.json'
    classes = 52

    file_path = '/liupengyu/PointTAD/outputs/Multithumos_results.csv'
    IOU = pd.read_csv(file_path)


    map = evaluate_mAP(IOU, "multithumos", 52)
    print("map in PointTAD: ", map)